...
public class Contact implements Comparable<Contact> {
    ...
    public Contact(Manifestation manifestation, Enseignant enseignant, String nomContact, String prenomContact, String emailContact, String etudes1Contact, String etudes2Contact, String descriptionContact) {
        ...
        this.dateContact = new Date(System.currentTimeMillis());
        this.heureContact = new Time(System.currentTimeMillis());
    ...
    public Contact(Manifestation manifestation, Enseignant enseignant, String nomContact, String prenomContact, String emailContact, String etudes1Contact, String etudes2Contact, Date dateContact, Time heureContact, String descriptionContact) {
        this.manifestation = manifestation;
        this.enseignant = enseignant;
        this.nomContact = nomContact;
        this.prenomContact = prenomContact;
